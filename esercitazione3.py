...
while True:
    ...
    #chiedo la base
        ...
        if base_torta=="pan di spagna":
            prezzo_cliente = prezzo_base[0]
        elif base_torta=="pasta frolla":
    ...
    #chiedo la farcitura
        ...
        if farcitura_torta=="cioccolato":
            prezzo_cliente = prezzo_farcitura[0]
        elif farcitura_torta=="crema chantilly":
    ...
    #chiedo i topping
        ...
        if topping_torta=="fragole":
            prezzo_cliente = prezzo_topping[0]
        elif topping_torta=="gocce di cioccolato":
        ...
        tot_torte += 1 # totale torte
        guadagno_tot += prezzotot_torta # guadagno totale
        print(tot_torte)
        print(guadagno_tot)
